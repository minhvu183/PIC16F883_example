...
FINAL_IMAGE=${DISTDIR}/01a-gpio_output.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/01a-gpio_output.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
