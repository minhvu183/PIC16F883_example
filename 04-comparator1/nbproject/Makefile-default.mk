...
FINAL_IMAGE=${DISTDIR}/06a-comparator1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/06a-comparator1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
